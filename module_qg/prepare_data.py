...
def main():
    ...
    datasets = nlp.load_dataset(data_args.script_name,
                                name=f"{data_args.qg_format}_qg_format",
                                data_dir=data_args.dataset_path,
                                data_files={'train': os.path.join(data_args.dataset_path, data_args.train_file_name),
                                            'validation': os.path.join(data_args.dataset_path,
                                                                       data_args.train_file_name)})
    ...
    if data_args.train_file_name is None:
        train_file_name = f"train_data_{data_args.task}_{data_args.qg_format}_{data_args.model_type}_gen_asr.pt"
        train_path = os.path.join(data_args.dataset_path, train_file_name)

        valid_file_name = f"valid_data_{data_args.task}_{data_args.qg_format}_{data_args.model_type}_gen_asr.pt"
        valid_path = os.path.join(data_args.dataset_path, valid_file_name)
    else:
        train_path = os.path.join(data_args.dataset_path, data_args.train_file_name)
        valid_path = os.path.join(data_args.dataset_path, data_args.valid_file_name)
    ...
    tokenizer_path = f"m{data_args.model_type}_qg_tokenizer"
